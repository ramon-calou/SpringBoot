...
$("#linkPromocao").on('change', function(){
	...
	if (url.length > 7){
		$.ajax({
			...
			statusCode: {
				404: function(){
					$("#alert").addClass("alert alert-danger").text("Nenhuma informação pode ser recuperada da URL.")
					$("#linkImagem").attr("src", "/images/promo-dark.png")
				}
			},
			error: function (){
				$("#alert").addClass("alert alert-danger").text("Algo deu errado, verifique a URL e tente mais tarde.")
				$("#linkImagem").attr("src", "/images/promo-dark.png")
			},
			complete: function (){
